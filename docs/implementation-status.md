...
| Diagnostics and privacy | Redacted diagnostics plus offline presence/revision/verified-revision/pending/sync/error entities; an entry-scoped non-fixable Repair reports unreadable private storage without overwriting it; no addresses/raw payloads/session material | Guided recovery and verified-restore timestamps remain open |
